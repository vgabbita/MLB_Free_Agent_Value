# MLB_FA_Valuation_Model

This project builds a data-driven system to identify the **most valuable** offensive free agent in Major League Baseball (MLB), using historical performance data, machine learning models, market valuation techniques, and aging-based risk adjustment
...
├── 2026_proj.py                  # From the collected raw data, utilizes linear regression to predict the raw offensive stats for the 2026 season
...
5. Run `market_val.py`
6. View `market_val.csv` to get the final list of the most valuable offensive free agents
